    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="bg-buc-black py-8 px-6 md:px-12 lg:px-20">
        <div className="max-w-[1440px] mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 md:gap-6 lg:gap-8">
            ...
            >
              <svg
                className="w-10 h-10 md:w-12 md:h-12 lg:w-[62px] lg:h-[62px]"
                viewBox="0 0 62 62"
                fill="none"
            ...
            >
              <svg
                className="w-10 h-10 md:w-12 md:h-12 lg:w-[63px] lg:h-[63px]"
                viewBox="0 0 63 63"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
            ...
            >
              <svg
                className="w-10 h-10 md:w-12 md:h-12 lg:w-[59px] lg:h-[59px]"
                viewBox="0 0 59 59"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
      ...
      <section className="relative h-[500px] md:h-[700px] lg:h-[900px] overflow-hidden">
        ...
        <div className="relative max-w-[1440px] mx-auto px-6 md:px-12 lg:px-20 h-full flex flex-col justify-end pb-12 md:pb-16 lg:pb-24">
          ...
          />
          <h1
            className="text-white font-bold text-3xl md:text-5xl lg:text-[64px] leading-[120%] tracking-[-0.02em] mb-6 md:mb-8"
