          ...
          <div className="flex items-center gap-4 md:gap-6 lg:gap-8">
            ...
            >
              <svg className="w-10 h-10 md:w-12 md:h-12 lg:w-[63px] lg:h-[63px]" viewBox="0 0 63 63" fill="none" xmlns="http://www.w3.org/2000/svg">
                <a href="https://www.instagram.com/blackundergraduatecoalition/?hl=en" target="_blank" style={{ cursor: 'pointer', pointerEvents: 'auto', color: 'rgba(255, 255, 255, 1)' }}>
            ...
            {/* Email */}
            <a href="#" aria-label="Email" className="hover:opacity-80 transition-opacity">
